...
function buildSingleVehicleDisplay($vehicle, $review)
{
...
function buildReviewDisplay($reviews)
{
   ...
   foreach ($reviews as $review) {
      ...
      $dv .= '<p>' . substr($review["clientFirstname"], 0 , 1) . $review["clientLastname"] . '</p>';
      $dv .= "<h4>$review[reviewText]</h4>";
      $dv .= "<p>$review[reviewDate]</p>";
      $dv .= "<hr>";
...
function buildDisplayReviewsForAdminClient($reviews)
{
   $dv = '<ul">';
   foreach ($reviews as $review) {
      $dv .= '<hr>';
      $dv .= '<h2>' . substr($review["clientFirstname"], 0 , 1) . $review["clientLastname"] . '</h2>';
      $dv .= "<h3>$review[reviewText]</h3>";
      $dv .= "<p>$review[reviewDate]</p>";
      $dv .=  '<a href="/phpmotors/review/?action=editReview&reviewId=' . $review["reviewId"] . '"><button>Update</button></a>';
      $dv .= '<a href="/phpmotors/review/?action=del&reviewId=' . $review["reviewId"] . '"><button>Delete</button></a>' ;
   }
   $dv .= '</ul>';
...
{
   $svd = '<section id="review">';
   $svd .= "<h3>$review[reviewText]<h3>";
   $svd .= "<p>$review[reviewDate]<p>";
   $svd .= '</section>';
   return $svd;
}
